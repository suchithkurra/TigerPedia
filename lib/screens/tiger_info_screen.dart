...
import 'package:tigerapp/Models/tiger_info.dart';// Import the Tiger_info class

class TigerDetailScreen extends StatelessWidget {

  final Tiger_info tiger;
          ...
          children: [
            ...
            Container(
              ...
              // Text('${tiger.tigerReserve}'),
                   // Text('Zone: ${tiger.zone}'),
                  //  Text('Area: ${tiger.area}'),
                   // Text('Father: ${tiger.father}'),
                   // Text('Mother: ${tiger.mother}'),
                  //  Text('Siblings: ${tiger.siblings}'),
                    Container(
                      padding: EdgeInsets.all(20),
                      child:Text('${tiger.details}', style: GoogleFonts.montserrat().copyWith(
                      fontSize: 16,
                    ...
                    child:Row(
                      children: [
                        ...
                        Container(
                          ...
                          child: Column(
                            children: [
                              Text('${tiger.name}', style: GoogleFonts.poppins().copyWith(
                                fontSize: 16,
                                fontWeight: FontWeight.w400
                              ),),
                              Text('Born ${tiger.born}', style: GoogleFonts.poppins().copyWith(
                                fontSize: 10
                              ),),
                              Text('Eastern India', style: GoogleFonts.poppins().copyWith(
                                fontSize: 8
                              ),)
